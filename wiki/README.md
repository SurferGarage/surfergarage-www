...
四篇工程文档 + **一篇前端重设计协议** + 本索引。改代码：**架构** 定位文件 → **规则** 理清分支 → **动效** / **排障** 按需；**重做 UI** 先读 **前端设计协议**。

| 文档 | 何时读 |
|------|--------|
| **[前端设计协议.md](./前端设计协议.md)** | **重设计目标 IA / Signal 组件 / Token / AI Prompt**（v1.0 协议） |
...
**最后对齐代码**：2026-07-13（`experiment/shader-field`）。历史变更查 Git，不在 wiki 堆日志。
